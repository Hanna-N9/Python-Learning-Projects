...
tarot = { 1:	"The Magician", 2:	"The High Priestess", 3:	"The Empress", 4:	"The Emperor", 5:	"The Hierophant", 6:	"The Lovers", 
         ...
         14:	"Temperance", 15:	"The Devil", 16:	"The Tower", 17:	"The Star", 18:	"The Moon", 19:	"The Sun", 20:	"Judgement", 
...
# The first card you draw is card 13. Pop the value assigned to the key 13 out of the tarot dictionary and assign it as the value 
# of the "past" key of spread
spread["past"] = tarot.pop(13)
print(spread) # {'past': 'Death'}


# The second card you draw is card 22. Pop the value assigned to the key 22 out of the tarot dictionary and assign it as the value 
# of the "present" key of spread
spread["present"] = tarot.pop(22)
print(spread) # {'past': 'Death', 'present': 'The Fool'}


# The third card you draw is card 10. Pop the value assigned to the key 10 out of the tarot dictionary and assign it as the value of 
# the "future" key of spread
spread["future"] = tarot.pop(10)
print(spread) # {'past': 'Death', 'present': 'The Fool', 'future': 'Wheel of Fortune'}
